...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'dashboardDetails')
        ...
        FFRoute(
          ...
          path: '/mapsColetas',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'maps_coletas')
              : MapsColetasWidget(
                  locaisColeta: params.getParam<LatLng>(
                    'locaisColeta',
                    ParamType.LatLng,
                    isList: true,
                  ),
        ...
        FFRoute(
          ...
          path: '/coletaPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'coletaPage')
              : const ColetaPageWidget(),
        ),
        FFRoute(
          name: 'calen',
          path: '/calen',
          builder: (context, params) => const CalenWidget(),
        ),
        FFRoute(
          name: 'agendaColeta',
          path: '/agendaColeta',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'agendaColeta')
              : const AgendaColetaWidget(),
        ),
        FFRoute(
          name: 'MY_Card',
          path: '/mYCard',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Captura_de_tela_2024-11-18_010301.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
